...
//        echo new \Exception('no reason');
     ...
     * @return void
     */
    private static function parseString(stdClass $type): void
    {
     ...
     * @throws \Exception
     */
    public static function equals(array $value, array $otherValue): bool
    {
...
//                        throw new SyntaxError("unterminated comment", 400);
     ...
     * @return array
     */
    public static function parse($string, $property = null, bool $capture_whitespace = true, $context = '', $contextName = ''): array
    {
        if (is_array($string)) {
...
//                    throw $e;
     ...
     * @return false|int
     */
    protected static function indexOf(array $array, $search, int $offset = 0)
    {
     ...
     * @return string
     */
    public static function getNumericValue(?object $value, array $options = []): ?string
    {
