...
class Lexer
{
    ...
    public function setContext($context)
    {
        ...
        $this->src = isset($context->src) ? $context->src : $this->parentOffset->src;
        $this->context = $context;
	 ...
	 * @throws Exception
	 */
	public function doTokenize($css, $src, $recover, $context, $parentStylesheet, $parentMediaRule)
	{
        ...
        while ($i++ < $j) {
                                ...
                                if ($isValidDeclaration && str_starts_with($value->type, 'invalid-')) {
                                    ...
                                    if ($value->type == 'invalid-css-function') {
                                        ...
                                        while ($c--) {
                                            ...
                                            if ($value->arguments[$c]->type == 'invalid-comment' || str_ends_with(isset($value->arguments[$c]->value) ? $value->arguments[$c]->value : '', ';')) {
            ...
            if ($name[0] == '@' || $char == '{') {
                ...
                if ($validRule) {
                    ...
                    if ((isset($parentStylesheet->type) ? $parentStylesheet->type : null) == 'Rule') {
    ...
    public function setParentOffset(\stdClass $parentOffset)
    {
        ...
        $this->src = isset($parentOffset->src) ? $parentOffset->src : '';
        return $this;
    }
	 ...
	 * @return int
	 */
    protected function getStatus($event, \stdClass $rule, $context, $parentStylesheet)
    {
